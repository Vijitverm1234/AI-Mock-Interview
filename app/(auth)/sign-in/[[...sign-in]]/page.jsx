...
export default function SignInPage() {
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-100">
      ...
      <div className="w-full md:w-1/2 h-[50vh] md:h-screen flex items-center justify-center bg-gray-200">
        <img
          src="https://i.pinimg.com/736x/c4/e4/f6/c4e4f6278baf62842fd6f4b02cf12f65.jpg" // Replace with your image URL
          alt="Sign In Visual"
